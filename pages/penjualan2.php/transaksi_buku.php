...
<li class="active">TRANSAKSI BUKU</li>
</ol>
</section>
<!-- Main content -->
...
{
?>
<tr class="pilih" data-id="<?php echo $row['id'];?>" data buku="<?php echo $row['nama_buku'];?>" data-harga="<?php echo
$row['harga'];?>">
...
document.getElementById("nama").value = $(this).attr('data-buku');
